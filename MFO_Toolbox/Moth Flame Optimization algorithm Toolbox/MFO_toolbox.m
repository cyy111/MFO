...
% --- Executes just before MFO_toolbox is made visible.
function MFO_toolbox_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to MFO_toolbox (see VARARGIN)

% Choose default command line output for MFO_toolbox
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes MFO_toolbox wait for user response (see UIRESUME)
